...
public struct CheckoutStrategy: OptionSet, RawRepresentable, ExpressibleByNilLiteral {
    public let rawValue: git_checkout_strategy_t.RawValue
    ...
    public init(rawValue: git_checkout_strategy_t.RawValue) {
        self.rawValue = rawValue
    }

    init(_ strategy: git_checkout_strategy_t) {
        self.rawValue = strategy.rawValue
    }
    ...
    public static let empty: Self = nil
